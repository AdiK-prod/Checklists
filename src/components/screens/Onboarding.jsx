...
export default function Onboarding() {
  ...
  return (
    <div className="min-h-screen bg-page flex flex-col px-4 pt-8 pb-6">
      ...
      {step === 1 && (
        <div className="flex-1 flex flex-col items-center justify-center text-center max-w-[340px] mx-auto">
          ...
          <h1 className="text-[22px] font-medium text-content-primary mb-3">
            Welcome to PackSmart
          </h1>
          <p className="text-16 text-content-secondary mb-8">
      ...
      {step === 2 && (
        <div className="max-w-[360px] mx-auto w-full">
          ...
          />
          <p className="text-12 text-content-secondary mt-2 mb-6">
          ...
          <button
            ...
            className="w-full mt-3 text-12 text-content-secondary"
          >
            I&apos;ll do this later
          </button>
        </div>
      ...
      {step === 3 && (
        <div className="max-w-[360px] mx-auto w-full flex-1 flex flex-col">
          ...
          <div className="bg-white rounded-card p-3 mb-4" style={{ border: '0.5px solid rgba(0,0,0,0.08)' }}>
            <input
              type="text"
              value={newName}
